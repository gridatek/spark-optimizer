...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('memory_spilled_bytes', sa.BigInteger(), nullable=True),
        sa.Column('disk_spilled_bytes', sa.BigInteger(), nullable=True),
        ...
        sa.Column('peak_memory_usage', sa.BigInteger(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('predicted_duration_ms', sa.BigInteger(), nullable=True),
